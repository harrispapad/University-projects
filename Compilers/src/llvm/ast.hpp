    ...
    public:
        ...
        virtual Value *igen() const override {
            ...
            if(is_string) {
                ...
                return Builder.CreateGlobalString(with_null, "lval_str");
            }
            else {
                /*get the pointer*/
                ...
                if(!expr_list.empty()) {
                    ...
                    if (elementType->isPointerTy()) {
                        ...
                        elemPtr = Builder.CreateGEP(baseType, base, indices);
            ...
            if(is_expr) {
                ...
                if (isRefParam || isCapturedVar) {
                    ...
                    Type *base_type = Type::getInt64Ty(TheContext);
        ...
        virtual Value *igen() const override {
            ...
            if (F == nullptr) {
                ...
                for (const auto& imp : implicit_params) {
                    ...
                    fd->captured_types[imp.first] = imp.second;
                }
