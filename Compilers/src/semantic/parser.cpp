...
{
       0,   138,   138,   143,   147,   148,   149,   150,   154,   155,
     159,   163,   164,   168,   169,   173,   174,   175,   179,   180,
     184,   185,   186,   187,   191,   195,   199,   200,   204,   208,
...
#line 138 "parser.y"
                                                  {std::cout << "AST: " << *(yyvsp[0].func_def) << std::endl;
                                                   st.enterScope(); (yyvsp[0].func_def)->sem_analyze(); st.exitScope();}
