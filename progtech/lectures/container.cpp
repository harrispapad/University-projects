...
//Doubly Linked List
template <typename T>
class dlist: public Container<T>, public Iterable<T>, public Visitable<T> {
public:
...
//Binary Search Tree
template <typename T>
class bstree: public Container<T>, public Iterable<T>, public Visitable<T> {
public:
